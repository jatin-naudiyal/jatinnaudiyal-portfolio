...
export default function Navbar({ activeSection }) {
  ...
  return (
    <nav style={{
      ...navStyles.nav,
      background: scrolled ? 'rgba(1,5,15,0.92)' : 'transparent',
      ...
      <div style={{ display: 'flex', gap: 2 }} className="desktop-nav">
        {links.map(l => (
          <motion.button
            ...
            style={{
              ...navStyles.link,
              color: activeSection === l.id ? 'var(--cyan)' : 'var(--muted)',
              background: activeSection === l.id ? 'rgba(0,229,255,0.06)' : 'none',
            }}
      ...
      <a href="mailto:iamjatinnaudiyal@gmail.com" style={navStyles.hire}
        ...
        {menuOpen && (
          <motion.div
            ...
            style={{
              ...
              background: 'rgba(1,5,15,0.97)', backdropFilter: 'blur(20px)',
          ...
          >
            {links.map(l => (
              <button key={l.id} onClick={() => scrollTo(l.id)}
                style={{ ...navStyles.link, fontSize: '1.3rem', color: activeSection === l.id ? 'var(--cyan)' : 'var(--text)', padding: '12px 32px' }}>
                {l.label}
              </button>
            ))}
            <a href="mailto:iamjatinnaudiyal@gmail.com" style={{ ...navStyles.hire, marginTop: 16 }}>Hire Me</a>
          </motion.div>
        )}
      </AnimatePresence>
