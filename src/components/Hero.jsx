...
const stats = [
  ...
  { value: '10TB+', label: 'Daily Ingestion' },
  ...
  return (
    <section id="hero" style={{ position: 'relative', minHeight: '100vh', display: 'flex', alignItems: 'center', overflow: 'hidden', padding: 0 }}>
      ...
      <div style={{
        ...
        background: 'linear-gradient(90deg, rgba(1,5,15,0.93) 0%, rgba(1,5,15,0.75) 55%, rgba(1,5,15,0.12) 100%)',
      }} />
      ...
      <div style={{ position: 'relative', zIndex: 2, width: '100%', maxWidth: 'var(--max-w)', margin: '0 auto', padding: 'calc(64px + 48px) var(--pad) 80px' }}>
        <motion.div custom={0} variants={fadeUp} initial="hidden" animate="visible">
          <div className="eyebrow">
            ...
            Senior Cloud &amp; DevOps Engineer · Cloudsufi
          </div>
        </motion.div>
        ...
        <motion.h1 custom={1} variants={fadeUp} initial="hidden" animate="visible"
          ...
          <span style={{ display: 'block' }}>Jatin</span>
          <span style={{ display: 'block', color: 'var(--cyan)' }}>Naudiyal<span style={{ color: 'rgba(0,229,255,0.4)' }}>.</span></span>
        </motion.h1>
        ...
        <motion.p custom={3} variants={fadeUp} initial="hidden" animate="visible"
          ...
          6+ years architecting production-grade cloud infrastructure on GCP &amp; Azure — specializing in Agentic AI-powered DevOps, Kubernetes orchestration, and enterprise-scale CI/CD automation.
        </motion.p>
        ...
        <motion.div custom={4} variants={fadeUp} initial="hidden" animate="visible"
          ...
          {stats.map((s, i) => (
            <div key={i} style={{ padding: '12px 22px', textAlign: 'center', borderRight: i < stats.length - 1 ? '1px solid var(--border)' : 'none' }}>
              <div style={{ fontFamily: 'var(--sans)', fontSize: '1.5rem', fontWeight: 700, color: 'var(--cyan)', lineHeight: 1 }}>{s.value}</div>
        ...
        <motion.div custom={5} variants={fadeUp} initial="hidden" animate="visible" style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          ...
          <a href="mailto:iamjatinnaudiyal@gmail.com" className="btn-outline">Get in Touch ↗</a>
        </motion.div>
      </div>
      ...
      <motion.div
        ...
        <motion.div style={{ width: 1, height: 48, background: 'linear-gradient(to bottom, var(--cyan), transparent)' }}
