...
/* ── Morphing DevOps Sphere — Cyan + Indigo palette ── */
    ...
    <group>
      ...
      {nodePositions.map((pos, i) => (
        <mesh key={i} position={pos} ref={el => nodesRef.current[i] = el}>
          ...
          <meshBasicMaterial color={i % 3 === 0 ? '#00E5FF' : i % 3 === 1 ? '#7C3AED' : '#38BDF8'} />
        </mesh>
      ))}
...
export default function HeroCanvas() {
  return (
    ...
    >
      ...
      <pointLight position={[8, 8, 8]}   color="#00E5FF" intensity={4} />
      <pointLight position={[-8, -6, -4]} color="#7C3AED" intensity={1.5} />
